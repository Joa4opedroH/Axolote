...
TIMER_INTERVAL = 1.3  # seconds
TAKEOFF_ALT = 3 # Takeoff altitude in meters
...
class Mapping():
    ...
    def __init__(self, connection_string='/dev/ttyACM1'):
        ...
        self.cap = cv2.VideoCapture(0)  # First camera (video0)
        self.current_capture = self.cap  # Set the current capture source
        
        self.script_dir = os.path.dirname(os.path.abspath(__file__))
        self.image_dir = os.path.join(self.script_dir, "images_competition")
